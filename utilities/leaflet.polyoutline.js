...
var PolyOutline = {
    ...
    //     if (text) {
    //         this.setOutline(null).setOutline(text, options);
    //     }
    // },

    setOutline: function (text, options) {
      this.options.weight = 45
      ...
      console.log(text, options);
        ...
        // /* setOutline will be called by onAdd, using value stored in this._text */
...
L.Polyline.include(PolyOutline);

L.LayerGroup.include({
    setOutline: function(text, options) {
        for (var layer in this._layers) {
            if (typeof this._layers[layer].setOutline === 'function') {
                this._layers[layer].setOutline(text, options);
                console.log("sdfds", this._layers[layer]);
            }
        }
        return this;
    }
